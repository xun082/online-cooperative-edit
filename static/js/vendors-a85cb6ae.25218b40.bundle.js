"use strict";
(self["webpackChunkedit"] = self["webpackChunkedit"] || []).push([["vendors-a85cb6ae"],{
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Jv: function() { return /* binding */ platform; },
/* harmony export */   Vj: function() { return /* binding */ cwd; }
/* harmony export */ });
/* unused harmony export env */
/* harmony import */ var _platform_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(48593);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
if (typeof _platform_js__WEBPACK_IMPORTED_MODULE_0__/* .globals */ .li.vscode !== 'undefined' && typeof _platform_js__WEBPACK_IMPORTED_MODULE_0__/* .globals */ .li.vscode.process !== 'undefined') {
    const sandboxProcess = _platform_js__WEBPACK_IMPORTED_MODULE_0__/* .globals */ .li.vscode.process;
    safeProcess = {
...
// Web environment
    ...
    safeProcess = {
        // Supported
        get platform() { return _platform_js__WEBPACK_IMPORTED_MODULE_0__/* .isWindows */ .ED ? 'win32' : _platform_js__WEBPACK_IMPORTED_MODULE_0__/* .isMacintosh */ .dz ? 'darwin' : 'linux'; },
...
/* harmony import */ var _network_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(32681);
/* harmony import */ var _path_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(45971);
/* harmony import */ var _platform_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(48593);
/* harmony import */ var _strings_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(70625);
/* harmony import */ var _uri_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(92378);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony export */ });
/* harmony import */ var _strings_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(70625);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
(function (Severity) {
    ...
    function fromValue(value) {
        ...
        if (_strings_js__WEBPACK_IMPORTED_MODULE_0__/* .equalsIgnoreCase */ .qq(_error, value)) {
            return Severity.Error;
        }
        if (_strings_js__WEBPACK_IMPORTED_MODULE_0__/* .equalsIgnoreCase */ .qq(_warning, value) || _strings_js__WEBPACK_IMPORTED_MODULE_0__/* .equalsIgnoreCase */ .qq(_warn, value)) {
            return Severity.Warning;
        }
        if (_strings_js__WEBPACK_IMPORTED_MODULE_0__/* .equalsIgnoreCase */ .qq(_info, value)) {
...
/* harmony export */   B4: function() { return /* binding */ noBreakWhitespace; },
...
/* harmony export */   J_: function() { return /* binding */ getCharContainingOffset; },
...
/* harmony export */   T5: function() { return /* binding */ isAsciiDigit; },
...
/* harmony export */   W1: function() { return /* binding */ GraphemeIterator; },
...
/* harmony export */   ZK: function() { return /* binding */ AmbiguousCharacters; },
...
/* harmony export */   vU: function() { return /* binding */ InvisibleCharacters; },
/* harmony export */   zY: function() { return /* binding */ compareIgnoreCase; }
/* harmony export */ });
/* unused harmony export CodePointIterator */
/* harmony import */ var _cache_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(30050);
/* harmony import */ var _lazy_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(41769);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
AmbiguousCharacters.ambiguousCharacterData = new _lazy_js__WEBPACK_IMPORTED_MODULE_0__/* .Lazy */ .o(() => {
...
AmbiguousCharacters.cache = new _cache_js__WEBPACK_IMPORTED_MODULE_1__/* .LRUCachedFunction */ .t((locales) => {
...
AmbiguousCharacters._locales = new _lazy_js__WEBPACK_IMPORTED_MODULE_0__/* .Lazy */ .o(() => Object.keys(AmbiguousCharacters.ambiguousCharacterData.value).filter((k) => !k.startsWith('_')));
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   n: function() { return /* binding */ MicrotaskDelay; }
/* harmony export */ });
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
...
/* harmony import */ var _codicons_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13113);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony export */ });
/* harmony import */ var _path_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(45971);
