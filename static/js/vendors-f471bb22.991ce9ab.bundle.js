"use strict";
(self["webpackChunkedit"] = self["webpackChunkedit"] || []).push([["vendors-f471bb22"],{
...
/* harmony import */ var _model_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11754);
/*---------------------------------------------------------------------------------------------
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/textModelBracketPairs.js
var textModelBracketPairs = __webpack_require__(86021);
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/beforeEditPositionMapper.js
var beforeEditPositionMapper = __webpack_require__(78109);
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/brackets.js
var brackets = __webpack_require__(40456);
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/length.js
var bracketPairsTree_length = __webpack_require__(30707);
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/parser.js + 2 modules
var parser = __webpack_require__(88941);
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/smallImmutableSet.js
var smallImmutableSet = __webpack_require__(92498);
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/tokenizer.js
var bracketPairsTree_tokenizer = __webpack_require__(11125);
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/combineTextEditInfos.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function combineTextEditInfos(textEditInfoFirst, textEditInfoSecond) {
    ...
    const s0ToS1Map = new arrays/* ArrayQueue */.H9(toLengthMapping(textEditInfoFirst));
    ...
    function nextS0ToS1MapWithS1LengthOf(s1Length) {
        ...
        const result = [];
        while (curItem && !(0,bracketPairsTree_length/* lengthIsZero */.xd)(s1Length)) {
            const [item, remainingItem] = curItem.splitAt(s1Length);
            result.push(item);
            s1Length = (0,bracketPairsTree_length/* lengthDiffNonNegative */.BE)(item.lengthAfter, s1Length);
            curItem = remainingItem !== null && remainingItem !== void 0 ? remainingItem : s0ToS1Map.dequeue();
        }
        if (!(0,bracketPairsTree_length/* lengthIsZero */.xd)(s1Length)) {
    ...
    function pushEdit(startOffset, endOffset, newLength) {
        if (result.length > 0 && (0,bracketPairsTree_length/* lengthEquals */.rM)(result[result.length - 1].endOffset, startOffset)) {
            const lastResult = result[result.length - 1];
            result[result.length - 1] = new beforeEditPositionMapper/* TextEditInfo */.Q(lastResult.startOffset, endOffset, (0,bracketPairsTree_length/* lengthAdd */.Ii)(lastResult.newLength, newLength));
        }
        else {
            result.push({ startOffset, endOffset, newLength });
        }
    }
    let s0offset = bracketPairsTree_length/* lengthZero */.xl;
    for (const s1ToS2 of s1ToS2Map) {
        const s0ToS1Map = nextS0ToS1MapWithS1LengthOf(s1ToS2.lengthBefore);
        if (s1ToS2.modified) {
            const s0Length = (0,bracketPairsTree_length/* sumLengths */.tQ)(s0ToS1Map, s => s.lengthBefore);
            const s0EndOffset = (0,bracketPairsTree_length/* lengthAdd */.Ii)(s0offset, s0Length);
            ...
            for (const s1 of s0ToS1Map) {
                ...
                s0offset = (0,bracketPairsTree_length/* lengthAdd */.Ii)(s0offset, s1.lengthBefore);
                if (s1.modified) {
...
class LengthMapping {
    ...
    splitAt(lengthAfter) {
        const remainingLengthAfter = (0,bracketPairsTree_length/* lengthDiffNonNegative */.BE)(lengthAfter, this.lengthAfter);
        if ((0,bracketPairsTree_length/* lengthEquals */.rM)(remainingLengthAfter, bracketPairsTree_length/* lengthZero */.xl)) {
            return [this, undefined];
        }
        else if (this.modified) {
            return [
                new LengthMapping(this.modified, this.lengthBefore, lengthAfter),
                new LengthMapping(this.modified, bracketPairsTree_length/* lengthZero */.xl, remainingLengthAfter)
            ];
        }
        else {
            return [
    ...
    toString() {
        return `${this.modified ? 'M' : 'U'}:${(0,bracketPairsTree_length/* lengthToObj */.Hw)(this.lengthBefore)} -> ${(0,bracketPairsTree_length/* lengthToObj */.Hw)(this.lengthAfter)}`;
    }
}
function toLengthMapping(textEditInfos) {
    const result = [];
    let lastOffset = bracketPairsTree_length/* lengthZero */.xl;
    for (const textEditInfo of textEditInfos) {
        const spaceLength = (0,bracketPairsTree_length/* lengthDiffNonNegative */.BE)(lastOffset, textEditInfo.startOffset);
        if (!(0,bracketPairsTree_length/* lengthIsZero */.xd)(spaceLength)) {
            result.push(new LengthMapping(false, spaceLength, spaceLength));
        }
        const lengthBefore = (0,bracketPairsTree_length/* lengthDiffNonNegative */.BE)(textEditInfo.startOffset, textEditInfo.endOffset);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/bracketPairsTree.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/model/bracketPairsTextModelPart/bracketPairsImpl.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var _length_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(30707);
/* harmony import */ var _smallImmutableSet_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(92498);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony export */ });
/* harmony import */ var _core_range_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(76584);
/* harmony import */ var _length_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(30707);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var _ast_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(65310);
/* harmony import */ var _length_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(30707);
/* harmony import */ var _smallImmutableSet_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(92498);
/* harmony import */ var _tokenizer_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(11125);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function lengthsToRange(lengthStart, lengthEnd) {
    ...
    const lineCount2 = Math.floor(l2 / factor);
    const colCount2 = l2 - lineCount2 * factor;
    return new _core_range_js__WEBPACK_IMPORTED_MODULE_1__/* .Range */ .e(lineCount + 1, colCount + 1, lineCount2 + 1, colCount2 + 1);
}
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/ast.js
var ast = __webpack_require__(65310);
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/beforeEditPositionMapper.js
var beforeEditPositionMapper = __webpack_require__(78109);
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/smallImmutableSet.js
var smallImmutableSet = __webpack_require__(92498);
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/length.js
var bracketPairsTree_length = __webpack_require__(30707);
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/concat23Trees.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/nodeReader.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/parser.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony export */ });
/* harmony import */ var _base_common_errors_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(50847);
/* harmony import */ var _encodedTokenAttributes_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(17915);
/* harmony import */ var _ast_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(65310);
/* harmony import */ var _length_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(30707);
/* harmony import */ var _smallImmutableSet_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(92498);
/*---------------------------------------------------------------------------------------------
...
/* harmony import */ var _core_editorColorRegistry_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(66050);
...
/* harmony export */ });
/* harmony import */ var _bracketPairsTree_brackets_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(40456);
/* harmony import */ var _bracketPairsTree_length_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(30707);
/* harmony import */ var _bracketPairsTree_parser_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(88941);
/* harmony import */ var _bracketPairsTree_smallImmutableSet_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(92498);
/* harmony import */ var _bracketPairsTree_tokenizer_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(11125);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
