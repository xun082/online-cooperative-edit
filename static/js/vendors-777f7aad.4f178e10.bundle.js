"use strict";
(self["webpackChunkedit"] = self["webpackChunkedit"] || []).push([["vendors-777f7aad"],{
...
/* harmony export */ });
/* harmony import */ var _core_lineRange_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(47599);
/*---------------------------------------------------------------------------------------------
...
class SmartLinesDiffComputer {
    computeDiff(originalLines, modifiedLines, options) {
        ...
        for (const c of result.changes) {
            ...
            let change = new linesDiffComputer/* LineRangeMapping */.f0(originalRange, modifiedRange, (_a = c.charChanges) === null || _a === void 0 ? void 0 : _a.map(c => new linesDiffComputer/* RangeMapping */.iy(new core_range/* Range */.e(c.originalStartLineNumber, c.originalStartColumn, c.originalEndLineNumber, c.originalEndColumn), new core_range/* Range */.e(c.modifiedStartLineNumber, c.modifiedStartColumn, c.modifiedEndLineNumber, c.modifiedEndColumn))));
            if (lastChange) {
    ...
    for (let i = 1; i < sequenceDiffs.length; i++) {
        ...
        if (cur.seq1Range.isEmpty) {
            ...
            if (all) {
                ...
                result[result.length - 1] = new SequenceDiff(lastResult.seq1Range, new offsetRange/* OffsetRange */.q(lastResult.seq2Range.start, cur.seq2Range.endExclusive - length));
                continue;
            }
        }
        result.push(cur);
...
class StandardLinesDiffComputer {
    ...
    computeDiff(originalLines, modifiedLines, options) {
        ...
        return new linesDiffComputer/* LinesDiff */.hZ(changes, hitTimeout);
    }
    refineDiff(originalLines, modifiedLines, diff, timeout, considerWhitespaceChanges) {
        ...
        const result = diffs.map((d) => new linesDiffComputer/* RangeMapping */.iy(sourceSlice.translateRange(d.seq1Range), targetSlice.translateRange(d.seq2Range)));
...
class Slice {
    ...
    translateOffset(offset) {
        ...
        return new position/* Position */.L(this.lineRange.start + i + 1, offset - offsetOfPrevLineBreak + 1 + this.offsetByLine[i]);
    }
...
/* harmony import */ var _platform_contextkey_common_contextkey_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(81043);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
