"use strict";
(self["webpackChunkedit"] = self["webpackChunkedit"] || []).push([["vendors-1d24e601"],{
...
/* harmony export */ });
/* harmony import */ var _editorDom_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(97624);
/* harmony import */ var _view_viewPart_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(23813);
/* harmony import */ var _viewParts_lines_viewLine_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(36095);
/* harmony import */ var _common_core_position_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(13372);
/* harmony import */ var _common_core_range_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(76584);
/* harmony import */ var _common_core_cursorColumns_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(21773);
/* harmony import */ var _base_browser_dom_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(39862);
/* harmony import */ var _common_cursor_cursorAtomicMoveOperations_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1304);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/controller/mouseTarget.js
var controller_mouseTarget = __webpack_require__(46598);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/viewEventHandler.js
var viewEventHandler = __webpack_require__(47341);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/controller/mouseHandler.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/controller/textAreaInput.js
var textAreaInput = __webpack_require__(33481);
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/controller/pointerHandler.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
// EXTERNAL MODULE: ./node_modules/.pnpm/css-loader@6.8.1_webpack@5.88.1/node_modules/css-loader/dist/cjs.js!./node_modules/.pnpm/postcss-loader@7.3.3_postcss@8.4.25_webpack@5.88.1/node_modules/postcss-loader/dist/cjs.js!./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/controller/textAreaHandler.css
var textAreaHandler = __webpack_require__(77031);
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/controller/textAreaHandler.css
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/controller/textAreaInput.js
var textAreaInput = __webpack_require__(33481);
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/controller/textAreaState.js
var textAreaState = __webpack_require__(1154);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/viewParts/lineNumbers/lineNumbers.js + 1 modules
var lineNumbers = __webpack_require__(10087);
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/viewParts/margin/margin.js + 1 modules
var margin = __webpack_require__(3155);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/core/wordCharacterClassifier.js
var wordCharacterClassifier = __webpack_require__(80238);
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/core/position.js
var position = __webpack_require__(13372);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/base/common/ime.js
var ime = __webpack_require__(58966);
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/controller/textAreaHandler.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
class TextAreaHandler extends viewPart/* ViewPart */.E {
    constructor(context, viewController, visibleRangeProvider) {
        ...
        this._textAreaInput = this._register(new textAreaInput/* TextAreaInput */.Fz(textAreaInputHost, textAreaWrapper, platform.OS, browser));
    ...
    _getWordBeforePosition(position) {
        const lineContent = this._context.viewModel.getLineContent(position.lineNumber);
        const wordSeparators = (0,wordCharacterClassifier/* getMapForWordSeparators */.u)(this._context.configuration.options.get(126 /* EditorOption.wordSeparators */));
    ...
    _getAriaLabel(options) {
        ...
        if (accessibilitySupport === 1 /* AccessibilitySupport.Disabled */) {
            return nls/* localize */.NC('accessibilityOffAriaLabel', "The editor is not accessible at this time. Press {0} for options.", platform/* isLinux */.IJ ? 'Shift+Alt+F1' : 'Alt+F1');
        }
    ...
    _ensureReadOnlyAttribute() {
        ...
        const useReadOnly = !ime/* IME */.F.enabled || (options.get(32 /* EditorOption.domReadOnly */) && options.get(88 /* EditorOption.readOnly */));
        if (useReadOnly) {
...
/* harmony import */ var _base_browser_event_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(91645);
/* harmony import */ var _base_browser_keyboardEvent_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(55022);
/* harmony import */ var _base_browser_performance_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(56097);
/* harmony import */ var _base_common_async_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(72432);
/* harmony import */ var _base_common_event_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(96290);
/* harmony import */ var _base_common_lifecycle_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(79027);
/* harmony import */ var _base_common_mime_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(13074);
/* harmony import */ var _base_common_strings_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(23607);
/* harmony import */ var _textAreaState_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(1154);
/* harmony import */ var _common_core_selection_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(74980);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var _common_core_range_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(76584);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
