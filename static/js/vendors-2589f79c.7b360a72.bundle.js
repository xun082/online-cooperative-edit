"use strict";
(self["webpackChunkedit"] = self["webpackChunkedit"] || []).push([["vendors-2589f79c"],{
...
__webpack_require__.d(__webpack_exports__, {
  Gm: function() { return /* binding */ CodeEditorWidget; }
});

// UNUSED EXPORTS: BooleanEventEmitter, EditorModeContext

// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/services/markerDecorations.js
var markerDecorations = __webpack_require__(19432);
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/widget/media/editor.css
var editor = __webpack_require__(91251);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/config/editorConfiguration.js + 1 modules
var editorConfiguration = __webpack_require__(46785);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/view.js
var browser_view = __webpack_require__(9908);
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/view/viewUserInputEvents.js
var view_viewUserInputEvents = __webpack_require__(81954);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/core/cursorColumns.js
var cursorColumns = __webpack_require__(21773);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/viewModel/viewModelImpl.js + 2 modules
var viewModelImpl = __webpack_require__(70732);
...
var serviceCollection = __webpack_require__(26072);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/viewModel/monospaceLineBreaksComputer.js
var monospaceLineBreaksComputer = __webpack_require__(38084);
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/view/domLineBreaksComputer.js
var domLineBreaksComputer = __webpack_require__(610);
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/cursor/cursorWordOperations.js
var cursorWordOperations = __webpack_require__(23156);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/widget/codeEditorContributions.js
/*---------------------------------------------------------------------------------------------
...
class CodeEditorContributions extends lifecycle/* Disposable */.JT {
    constructor() {
        super();
        this._editor = null;
         ...
         */
        this._instances = this._register(new lifecycle/* DisposableMap */.b2());
        /**
    ...
    initialize(editor, contributions, instantiationService) {
        ...
        for (const desc of contributions) {
            if (this._pending.has(desc.id)) {
                (0,errors/* onUnexpectedError */.dL)(new Error(`Cannot have two contributions with the same id ${desc.id}`));
                continue;
            }
        ...
        this._register((0,common_async/* runWhenIdle */.To)(() => {
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/config/tabFocus.js
var tabFocus = __webpack_require__(89735);
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/browser/widget/codeEditorWidget.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
class ModelData {
    ...
    dispose() {
        (0,lifecycle/* dispose */.B9)(this.listenersToRemove);
...
let CodeEditorWidget = class CodeEditorWidget extends lifecycle/* Disposable */.JT {
    //#endregion
    get isSimpleWidget() {
    ...
    constructor(domElement, _options, codeEditorWidgetOptions, instantiationService, codeEditorService, commandService, contextKeyService, themeService, notificationService, accessibilityService, languageConfigurationService, languageFeaturesService) {
        ...
        //#region Eventing
        this._deliveryQueue = new common_event/* EventDeliveryQueue */.F3();
        ...
        this._onDidChangeModelContent = this._register(new common_event/* Emitter */.Q5({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeModelContent = this._onDidChangeModelContent.event;
        this._onDidChangeModelLanguage = this._register(new common_event/* Emitter */.Q5({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeModelLanguage = this._onDidChangeModelLanguage.event;
        this._onDidChangeModelLanguageConfiguration = this._register(new common_event/* Emitter */.Q5({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeModelLanguageConfiguration = this._onDidChangeModelLanguageConfiguration.event;
        this._onDidChangeModelOptions = this._register(new common_event/* Emitter */.Q5({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeModelOptions = this._onDidChangeModelOptions.event;
        this._onDidChangeModelDecorations = this._register(new common_event/* Emitter */.Q5({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeModelDecorations = this._onDidChangeModelDecorations.event;
        this._onDidChangeModelTokens = this._register(new common_event/* Emitter */.Q5({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeModelTokens = this._onDidChangeModelTokens.event;
        this._onDidChangeConfiguration = this._register(new common_event/* Emitter */.Q5({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeConfiguration = this._onDidChangeConfiguration.event;
        this._onDidChangeModel = this._register(new common_event/* Emitter */.Q5({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeModel = this._onDidChangeModel.event;
        this._onDidChangeCursorPosition = this._register(new common_event/* Emitter */.Q5({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeCursorPosition = this._onDidChangeCursorPosition.event;
        this._onDidChangeCursorSelection = this._register(new common_event/* Emitter */.Q5({ deliveryQueue: this._deliveryQueue }));
        ...
        this._onDidLayoutChange = this._register(new common_event/* Emitter */.Q5({ deliveryQueue: this._deliveryQueue }));
        ...
        this._onDidContentSizeChange = this._register(new common_event/* Emitter */.Q5({ deliveryQueue: this._deliveryQueue }));
        this.onDidContentSizeChange = this._onDidContentSizeChange.event;
        this._onDidScrollChange = this._register(new common_event/* Emitter */.Q5({ deliveryQueue: this._deliveryQueue }));
        this.onDidScrollChange = this._onDidScrollChange.event;
        this._onDidChangeViewZones = this._register(new common_event/* Emitter */.Q5({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeViewZones = this._onDidChangeViewZones.event;
        this._onDidChangeHiddenAreas = this._register(new common_event/* Emitter */.Q5({ deliveryQueue: this._deliveryQueue }));
        ...
        this._instantiationService = instantiationService.createChild(new serviceCollection/* ServiceCollection */.y([contextkey/* IContextKeyService */.i6, this._contextKeyService]));
        ...
        if (Array.isArray(codeEditorWidgetOptions.contributions)) {
            ...
            contributions = editorExtensions/* EditorExtensionsRegistry */.Uc.getEditorContributions();
        }
        this._contributions.initialize(this, contributions, this._instantiationService);
        for (const action of editorExtensions/* EditorExtensionsRegistry */.Uc.getEditorActions()) {
            if (this._actions.has(action.id)) {
                (0,errors/* onUnexpectedError */.dL)(new Error(`Cannot have two actions with the same id ${action.id}`));
                continue;
            }
            const internalAction = new editorAction/* InternalEditorAction */.p(action.id, action.label, action.alias, (0,types/* withNullAsUndefined */.f6)(action.precondition), () => {
        ...
        this._register(new dom/* DragAndDropObserver */.eg(this._domElement, {
    ...
    _createConfiguration(isSimpleWidget, options, accessibilityService) {
        return new editorConfiguration/* EditorConfiguration */.z(isSimpleWidget, options, this._domElement, accessibilityService);
    }
    getId() {
        return this.getEditorType() + ':' + this._id;
    }
    getEditorType() {
        return editorCommon/* EditorType */.g.ICodeEditor;
    }
    dispose() {
    ...
    getConfiguredWordAtPosition(position) {
        ...
        return cursorWordOperations/* WordOperations */.w.getWordAtPosition(this._modelData.model, this._configuration.options.get(126 /* EditorOption.wordSeparators */), position);
    }
    ...
    setHiddenAreas(ranges, source) {
        var _a;
        (_a = this._modelData) === null || _a === void 0 ? void 0 : _a.viewModel.setHiddenAreas(ranges.map(r => core_range/* Range */.e.lift(r)), source);
    }
    getVisibleColumnFromPosition(rawPosition) {
        ...
        return cursorColumns/* CursorColumns */.i.visibleColumnFromColumn(this._modelData.model.getLineContent(position.lineNumber), position.column, tabSize) + 1;
    }
    getPosition() {
        if (!this._modelData) {
            return null;
    ...
    setPosition(position, source = 'api') {
        ...
        if (!core_position/* Position */.L.isIPosition(position)) {
    ...
    _sendRevealRange(modelRange, verticalType, revealHorizontal, scrollType) {
        ...
        if (!core_range/* Range */.e.isIRange(modelRange)) {
            throw new Error('Invalid arguments');
        }
    ...
    _revealLine(lineNumber, revealType, scrollType) {
        ...
        this._sendRevealRange(new core_range/* Range */.e(lineNumber, 1, lineNumber, 1), revealType, false, scrollType);
    }
    ...
    _revealPosition(position, verticalType, revealHorizontal, scrollType) {
        ...
        this._sendRevealRange(new core_range/* Range */.e(position.lineNumber, position.column, position.lineNumber, position.column), verticalType, revealHorizontal, scrollType);
    }
    getSelection() {
        if (!this._modelData) {
            return null;
    ...
    setSelection(something, source = 'api') {
        const isSelection = core_selection/* Selection */.Y.isISelection(something);
        const isRange = core_range/* Range */.e.isIRange(something);
    ...
    _setSelectionImpl(sel, source) {
        ...
        const selection = new core_selection/* Selection */.Y(sel.selectionStartLineNumber, sel.selectionStartColumn, sel.positionLineNumber, sel.positionColumn);
    ...
    _revealLines(startLineNumber, endLineNumber, verticalType, scrollType) {
        ...
        this._sendRevealRange(new core_range/* Range */.e(startLineNumber, 1, endLineNumber, 1), verticalType, false, scrollType);
    }
    ...
    _revealRange(range, verticalType, revealHorizontal, scrollType) {
        if (!core_range/* Range */.e.isIRange(range)) {
            throw new Error('Invalid arguments');
        }
        this._sendRevealRange(core_range/* Range */.e.lift(range), verticalType, revealHorizontal, scrollType);
    }
    setSelections(ranges, source = 'api', reason = 0 /* CursorChangeReason.NotSet */) {
        ...
        for (let i = 0, len = ranges.length; i < len; i++) {
            if (!core_selection/* Selection */.Y.isISelection(ranges[i])) {
                throw new Error('Invalid arguments');
            }
        }
    ...
    trigger(source, handlerId, payload) {
        ...
        if (action) {
            Promise.resolve(action.run(payload)).then(undefined, errors/* onUnexpectedError */.dL);
            return;
        }
        if (!this._modelData) {
            return;
    ...
    _paste(source, text, pasteOnNewLine, multicursorText, mode) {
        ...
        if (source === 'keyboard') {
            this._onDidPaste.fire({
                range: new core_range/* Range */.e(startPosition.lineNumber, startPosition.column, endPosition.lineNumber, endPosition.column),
                languageId: mode
            });
        }
    }
    ...
    _triggerEditorCommand(source, handlerId, payload) {
        const command = editorExtensions/* EditorExtensionsRegistry */.Uc.getEditorCommand(handlerId);
        if (command) {
            payload = payload || {};
            payload.source = source;
            this._instantiationService.invokeFunction((accessor) => {
                Promise.resolve(command.runEditorCommand(accessor, this, payload)).then(undefined, errors/* onUnexpectedError */.dL);
            });
            return true;
        }
        return false;
    ...
    getLineDecorations(lineNumber) {
        ...
        return this._modelData.model.getLineDecorations(lineNumber, this._id, (0,editorOptions/* filterValidationDecorations */.$J)(this._configuration.options));
    }
    getDecorationsInRange(range) {
        if (!this._modelData) {
            return null;
        }
        return this._modelData.model.getDecorationsInRange(range, this._id, (0,editorOptions/* filterValidationDecorations */.$J)(this._configuration.options));
    }
    /**
     * @deprecated
     */
    ...
    applyFontInfo(target) {
        (0,domFontInfo/* applyFontInfo */.N)(target, this._configuration.options.get(48 /* EditorOption.fontInfo */));
    }
    ...
    _attachModel(model) {
        ...
        const viewModel = new viewModelImpl/* ViewModel */.j(this._id, this._configuration, model, domLineBreaksComputer/* DOMLineBreaksComputerFactory */.C.create(), monospaceLineBreaksComputer/* MonospaceLineBreaksComputerFactory */.p.create(this._configuration.options), (callback) => dom/* scheduleAtNextAnimationFrame */.jL(callback), this.languageConfigurationService, this._themeService, attachedView);
            ...
            switch (e.kind) {
                ...
                case 6 /* OutgoingViewModelEventKind.CursorStateChanged */: {
                    if (e.reachedMaxCursorCount) {
                        ...
                        const message = nls/* localize */.NC('cursors.maximum', "The number of cursors has been limited to {0}. Consider using [find and replace](https://code.visualstudio.com/docs/editor/codebasics#_find-and-replace) for larger changes or increase the editor multi cursor limit setting.", multiCursorLimit);
                        this._notificationService.prompt(notification/* Severity */.zb.Warning, message, [
                            {
                            ...
                            {
                                label: nls/* localize */.NC('goToSetting', 'Increase Multi Cursor Limit'),
                                run: () => {
    ...
    _createView(viewModel) {
        ...
        const viewUserInputEvents = new view_viewUserInputEvents/* ViewUserInputEvents */.q(viewModel.coordinatesConverter);
        ...
        const view = new browser_view/* View */.G(commandDelegate, this._configuration, this._themeService.getColorTheme(), viewModel, viewUserInputEvents, this._overflowWidgetsDomNode);
        return [view, true];
    }
    ...
    showDropIndicatorAt(position) {
        const newDecorations = [{
                range: new core_range/* Range */.e(position.lineNumber, position.column, position.lineNumber, position.column),
...
CodeEditorWidget.dropIntoEditorDecorationOptions = textModel/* ModelDecorationOptions */.qx.register({
...
class BooleanEventEmitter extends lifecycle/* Disposable */.JT {
    constructor(_emitterOptions) {
        super();
        this._emitterOptions = _emitterOptions;
        this._onDidChangeToTrue = this._register(new common_event/* Emitter */.Q5(this._emitterOptions));
        this.onDidChangeToTrue = this._onDidChangeToTrue.event;
        this._onDidChangeToFalse = this._register(new common_event/* Emitter */.Q5(this._emitterOptions));
 ...
 */
class InteractionEmitter extends common_event/* Emitter */.Q5 {
...
class EditorContextKeysManager extends lifecycle/* Disposable */.JT {
    constructor(editor, contextKeyService) {
        super();
        this._editor = editor;
        contextKeyService.createKey('editorId', editor.getId());
        this._editorSimpleInput = editorContextKeys/* EditorContextKeys */.u.editorSimpleInput.bindTo(contextKeyService);
        this._editorFocus = editorContextKeys/* EditorContextKeys */.u.focus.bindTo(contextKeyService);
        this._textInputFocus = editorContextKeys/* EditorContextKeys */.u.textInputFocus.bindTo(contextKeyService);
        this._editorTextFocus = editorContextKeys/* EditorContextKeys */.u.editorTextFocus.bindTo(contextKeyService);
        this._editorTabMovesFocus = editorContextKeys/* EditorContextKeys */.u.tabMovesFocus.bindTo(contextKeyService);
        this._editorReadonly = editorContextKeys/* EditorContextKeys */.u.readOnly.bindTo(contextKeyService);
        this._inDiffEditor = editorContextKeys/* EditorContextKeys */.u.inDiffEditor.bindTo(contextKeyService);
        this._editorColumnSelection = editorContextKeys/* EditorContextKeys */.u.columnSelection.bindTo(contextKeyService);
        this._hasMultipleSelections = editorContextKeys/* EditorContextKeys */.u.hasMultipleSelections.bindTo(contextKeyService);
        this._hasNonEmptySelection = editorContextKeys/* EditorContextKeys */.u.hasNonEmptySelection.bindTo(contextKeyService);
        this._canUndo = editorContextKeys/* EditorContextKeys */.u.canUndo.bindTo(contextKeyService);
        this._canRedo = editorContextKeys/* EditorContextKeys */.u.canRedo.bindTo(contextKeyService);
        ...
        this._register(tabFocus/* TabFocus */.n.onDidChangeTabFocus(() => this._editorTabMovesFocus.set(tabFocus/* TabFocus */.n.getTabFocusMode("editorFocus" /* TabFocusContext.Editor */))));
    ...
    _updateFromConfig() {
        ...
        this._editorTabMovesFocus.set(tabFocus/* TabFocus */.n.getTabFocusMode("editorFocus" /* TabFocusContext.Editor */));
...
class EditorModeContext extends lifecycle/* Disposable */.JT {
    constructor(_editor, _contextKeyService, _languageFeaturesService) {
        super();
        this._editor = _editor;
        this._contextKeyService = _contextKeyService;
        this._languageFeaturesService = _languageFeaturesService;
        this._langId = editorContextKeys/* EditorContextKeys */.u.languageId.bindTo(_contextKeyService);
        this._hasCompletionItemProvider = editorContextKeys/* EditorContextKeys */.u.hasCompletionItemProvider.bindTo(_contextKeyService);
        this._hasCodeActionsProvider = editorContextKeys/* EditorContextKeys */.u.hasCodeActionsProvider.bindTo(_contextKeyService);
        this._hasCodeLensProvider = editorContextKeys/* EditorContextKeys */.u.hasCodeLensProvider.bindTo(_contextKeyService);
        this._hasDefinitionProvider = editorContextKeys/* EditorContextKeys */.u.hasDefinitionProvider.bindTo(_contextKeyService);
        this._hasDeclarationProvider = editorContextKeys/* EditorContextKeys */.u.hasDeclarationProvider.bindTo(_contextKeyService);
        this._hasImplementationProvider = editorContextKeys/* EditorContextKeys */.u.hasImplementationProvider.bindTo(_contextKeyService);
        this._hasTypeDefinitionProvider = editorContextKeys/* EditorContextKeys */.u.hasTypeDefinitionProvider.bindTo(_contextKeyService);
        this._hasHoverProvider = editorContextKeys/* EditorContextKeys */.u.hasHoverProvider.bindTo(_contextKeyService);
        this._hasDocumentHighlightProvider = editorContextKeys/* EditorContextKeys */.u.hasDocumentHighlightProvider.bindTo(_contextKeyService);
        this._hasDocumentSymbolProvider = editorContextKeys/* EditorContextKeys */.u.hasDocumentSymbolProvider.bindTo(_contextKeyService);
        this._hasReferenceProvider = editorContextKeys/* EditorContextKeys */.u.hasReferenceProvider.bindTo(_contextKeyService);
        this._hasRenameProvider = editorContextKeys/* EditorContextKeys */.u.hasRenameProvider.bindTo(_contextKeyService);
        this._hasSignatureHelpProvider = editorContextKeys/* EditorContextKeys */.u.hasSignatureHelpProvider.bindTo(_contextKeyService);
        this._hasInlayHintsProvider = editorContextKeys/* EditorContextKeys */.u.hasInlayHintsProvider.bindTo(_contextKeyService);
        this._hasDocumentFormattingProvider = editorContextKeys/* EditorContextKeys */.u.hasDocumentFormattingProvider.bindTo(_contextKeyService);
        this._hasDocumentSelectionFormattingProvider = editorContextKeys/* EditorContextKeys */.u.hasDocumentSelectionFormattingProvider.bindTo(_contextKeyService);
        this._hasMultipleDocumentFormattingProvider = editorContextKeys/* EditorContextKeys */.u.hasMultipleDocumentFormattingProvider.bindTo(_contextKeyService);
        this._hasMultipleDocumentSelectionFormattingProvider = editorContextKeys/* EditorContextKeys */.u.hasMultipleDocumentSelectionFormattingProvider.bindTo(_contextKeyService);
        this._isInWalkThrough = editorContextKeys/* EditorContextKeys */.u.isInWalkThroughSnippet.bindTo(_contextKeyService);
    ...
    _update() {
        ...
        this._contextKeyService.bufferChangeEvents(() => {
            ...
            this._isInWalkThrough.set(model.uri.scheme === network/* Schemas */.lg.walkThroughSnippet);
        });
    }
}
class CodeEditorWidgetFocusTracker extends lifecycle/* Disposable */.JT {
    constructor(domElement) {
        super();
        this._onChange = this._register(new common_event/* Emitter */.Q5());
        this.onChange = this._onChange.event;
        this._hasFocus = false;
        this._domFocusTracker = this._register(dom/* trackFocus */.go(domElement));
...
(0,themeService/* registerThemingParticipant */.Ic)((theme, collector) => {
    const errorForeground = theme.getColor(colorRegistry/* editorErrorForeground */.lXJ);
    if (errorForeground) {
    ...
    const warningForeground = theme.getColor(colorRegistry/* editorWarningForeground */.uoC);
    ...
    const infoForeground = theme.getColor(colorRegistry/* editorInfoForeground */.c63);
    if (infoForeground) {
    ...
    const hintForeground = theme.getColor(colorRegistry/* editorHintForeground */.Dut);
    if (hintForeground) {
    ...
    const unnecessaryForeground = theme.getColor(editorColorRegistry/* editorUnnecessaryCodeOpacity */.zu);
