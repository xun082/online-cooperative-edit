"use strict";
(self["webpackChunkedit"] = self["webpackChunkedit"] || []).push([["vendors-ad38c252"],{
...
// UNUSED EXPORTS: SelectionAnchorSet
...
// EXTERNAL MODULE: ./node_modules/.pnpm/css-loader@6.8.1_webpack@5.88.2/node_modules/css-loader/dist/cjs.js!./node_modules/.pnpm/postcss-loader@7.3.3_postcss@8.4.28_webpack@5.88.2/node_modules/postcss-loader/dist/cjs.js!./node_modules/.pnpm/monaco-editor@0.41.0/node_modules/monaco-editor/esm/vs/editor/contrib/anchorSelect/browser/anchorSelect.css
var anchorSelect = __webpack_require__(93354);
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.41.0/node_modules/monaco-editor/esm/vs/editor/contrib/anchorSelect/browser/anchorSelect.css
...
var update = injectStylesIntoStyleTag_default()(anchorSelect/* default */.Z, options);




       /* harmony default export */ var browser_anchorSelect = (anchorSelect/* default */.Z && anchorSelect/* default */.Z.locals ? anchorSelect/* default */.Z.locals : undefined);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.41.0/node_modules/monaco-editor/esm/vs/editor/contrib/anchorSelect/browser/anchorSelect.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
    ...
    setSelectionAnchor() {
        if (this.editor.hasModel()) {
            ...
            this.editor.changeDecorations((accessor) => {
                ...
                this.decorationId = accessor.addDecoration(selection/* Selection */.Y.fromPositions(position, position), {
                    description: 'selection-anchor',
                    stickiness: 1 /* TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges */,
                    hoverMessage: new htmlContent/* MarkdownString */.W5().appendText((0,nls/* localize */.NC)('selectionAnchor', "Selection Anchor")),
                    className: 'selection-anchor'
                });
            });
            this.selectionAnchorSetContextKey.set(!!this.decorationId);
            (0,aria/* alert */.Z9)((0,nls/* localize */.NC)('anchorSet', "Anchor set at {0}:{1}", position.lineNumber, position.column));
        }
    }
    goToSelectionAnchor() {
...
class SetSelectionAnchor extends editorExtensions/* EditorAction */.R6 {
    constructor() {
        super({
            ...
            label: (0,nls/* localize */.NC)('setSelectionAnchor', "Set Selection Anchor"),
            alias: 'Set Selection Anchor',
            precondition: undefined,
            kbOpts: {
                kbExpr: editorContextKeys/* EditorContextKeys */.u.editorTextFocus,
                primary: (0,keyCodes/* KeyChord */.gx)(2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */, 2048 /* KeyMod.CtrlCmd */ | 32 /* KeyCode.KeyB */),
...
class GoToSelectionAnchor extends editorExtensions/* EditorAction */.R6 {
    constructor() {
        super({
            ...
            label: (0,nls/* localize */.NC)('goToSelectionAnchor', "Go to Selection Anchor"),
...
class SelectFromAnchorToCursor extends editorExtensions/* EditorAction */.R6 {
    constructor() {
        super({
            ...
            label: (0,nls/* localize */.NC)('selectFromAnchorToCursor', "Select from Anchor to Cursor"),
            alias: 'Select from Anchor to Cursor',
            precondition: SelectionAnchorSet,
            kbOpts: {
                kbExpr: editorContextKeys/* EditorContextKeys */.u.editorTextFocus,
                primary: (0,keyCodes/* KeyChord */.gx)(2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */, 2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */),
                weight: 100 /* KeybindingWeight.EditorContrib */
            }
        });
    }
...
class CancelSelectionAnchor extends editorExtensions/* EditorAction */.R6 {
    constructor() {
        super({
            ...
            label: (0,nls/* localize */.NC)('cancelSelectionAnchor', "Cancel Selection Anchor"),
...
(0,editorExtensions/* registerEditorContribution */._K)(SelectionAnchorController.ID, SelectionAnchorController, 4 /* EditorContributionInstantiation.Lazy */);
...
// UNUSED EXPORTS: BracketMatchingController
...
var styleTagTransform = __webpack_require__(89396);
var styleTagTransform_default = /*#__PURE__*/__webpack_require__.n(styleTagTransform);
// EXTERNAL MODULE: ./node_modules/.pnpm/css-loader@6.8.1_webpack@5.88.2/node_modules/css-loader/dist/cjs.js!./node_modules/.pnpm/postcss-loader@7.3.3_postcss@8.4.28_webpack@5.88.2/node_modules/postcss-loader/dist/cjs.js!./node_modules/.pnpm/monaco-editor@0.41.0/node_modules/monaco-editor/esm/vs/editor/contrib/bracketMatching/browser/bracketMatching.css
var bracketMatching = __webpack_require__(39723);
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.41.0/node_modules/monaco-editor/esm/vs/editor/contrib/bracketMatching/browser/bracketMatching.css
...
var update = injectStylesIntoStyleTag_default()(bracketMatching/* default */.Z, options);




       /* harmony default export */ var browser_bracketMatching = (bracketMatching/* default */.Z && bracketMatching/* default */.Z.locals ? bracketMatching/* default */.Z.locals : undefined);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.41.0/node_modules/monaco-editor/esm/vs/editor/contrib/bracketMatching/browser/bracketMatching.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
const overviewRulerBracketMatchForeground = (0,colorRegistry/* registerColor */.P6G)('editorOverviewRuler.bracketMatchForeground', { dark: '#A0A0A0', light: '#A0A0A0', hcDark: '#A0A0A0', hcLight: '#A0A0A0' }, nls/* localize */.NC('overviewRulerBracketMatchForeground', 'Overview ruler marker color for matching brackets.'));
class JumpToBracketAction extends editorExtensions/* EditorAction */.R6 {
    constructor() {
        super({
            id: 'editor.action.jumpToBracket',
            label: nls/* localize */.NC('smartSelect.jumpBracket', "Go to Bracket"),
            alias: 'Go to Bracket',
            precondition: undefined,
            kbOpts: {
                kbExpr: editorContextKeys/* EditorContextKeys */.u.editorTextFocus,
...
class SelectToBracketAction extends editorExtensions/* EditorAction */.R6 {
    constructor() {
        super({
            id: 'editor.action.selectToBracket',
            label: nls/* localize */.NC('smartSelect.selectToBracket', "Select to Bracket"),
...
class RemoveBracketsAction extends editorExtensions/* EditorAction */.R6 {
    constructor() {
        super({
            id: 'editor.action.removeBrackets',
            label: nls/* localize */.NC('smartSelect.removeBrackets', "Remove Brackets"),
...
class BracketMatchingController extends lifecycle/* Disposable */.JT {
    static get(editor) {
    ...
    constructor(editor) {
        ...
        this._updateBracketsSoon = this._register(new common_async/* RunOnceScheduler */.pY(() => this._updateBrackets(), 50));
    ...
    jumpToBracket() {
        ...
        const newSelections = this._editor.getSelections().map(selection => {
            ...
            return new core_selection/* Selection */.Y(position.lineNumber, position.column, position.lineNumber, position.column);
        });
    ...
    selectToBracket(selectBrackets) {
        ...
        this._editor.getSelections().forEach(selection => {
            ...
            let selectTo = null;
            if (brackets) {
                brackets.sort(range/* Range */.e.compareRangesUsingStarts);
            ...
            if (selectFrom && selectTo) {
                newSelections.push(new core_selection/* Selection */.Y(selectFrom.lineNumber, selectFrom.column, selectTo.lineNumber, selectTo.column));
            }
        });
    ...
    _recomputeBrackets() {
        ...
        if (positions.length > 1) {
            positions.sort(position/* Position */.L.compare);
        }
        const newData = [];
        let newDataLen = 0;
        let previousIndex = 0;
...
BracketMatchingController._DECORATION_OPTIONS_WITH_OVERVIEW_RULER = textModel/* ModelDecorationOptions */.qx.register({
    description: 'bracket-match-overview',
    stickiness: 1 /* TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges */,
    className: 'bracket-match',
    overviewRuler: {
        color: (0,themeService/* themeColorFromId */.EN)(overviewRulerBracketMatchForeground),
        position: model/* OverviewRulerLane */.sh.Center
    }
});
BracketMatchingController._DECORATION_OPTIONS_WITHOUT_OVERVIEW_RULER = textModel/* ModelDecorationOptions */.qx.register({
    description: 'bracket-match-no-overview',
    stickiness: 1 /* TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges */,
    className: 'bracket-match'
});
(0,editorExtensions/* registerEditorContribution */._K)(BracketMatchingController.ID, BracketMatchingController, 1 /* EditorContributionInstantiation.AfterFirstRender */);
(0,editorExtensions/* registerEditorAction */.Qr)(SelectToBracketAction);
(0,editorExtensions/* registerEditorAction */.Qr)(JumpToBracketAction);
(0,editorExtensions/* registerEditorAction */.Qr)(RemoveBracketsAction);
// Go to menu
actions/* MenuRegistry */.BH.appendMenuItem(actions/* MenuId */.eH.MenubarGoMenu, {
    group: '5_infile_nav',
    command: {
        id: 'editor.action.jumpToBracket',
        title: nls/* localize */.NC({ key: 'miGoToBracket', comment: ['&& denotes a mnemonic'] }, "Go to &&Bracket")
    },
    order: 2
});
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.41.0/node_modules/monaco-editor/esm/vs/editor/common/core/selection.js
var selection = __webpack_require__(2257);
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.41.0/node_modules/monaco-editor/esm/vs/editor/contrib/caretOperations/browser/moveCaretCommand.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
class MoveCaretCommand {
    ...
    getEditOperations(model, builder) {
        ...
        if (this._isMovingLeft) {
            const rangeBefore = new range/* Range */.e(lineNumber, startColumn - 1, lineNumber, startColumn);
            const charBefore = model.getValueInRange(rangeBefore);
            builder.addEditOperation(rangeBefore, null);
            builder.addEditOperation(new range/* Range */.e(lineNumber, endColumn, lineNumber, endColumn), charBefore);
        }
        else {
            const rangeAfter = new range/* Range */.e(lineNumber, endColumn, lineNumber, endColumn + 1);
            const charAfter = model.getValueInRange(rangeAfter);
            builder.addEditOperation(rangeAfter, null);
            builder.addEditOperation(new range/* Range */.e(lineNumber, startColumn, lineNumber, startColumn), charAfter);
        }
    }
    computeCursorState(model, helper) {
        if (this._isMovingLeft) {
            return new selection/* Selection */.Y(this._selection.startLineNumber, this._selection.startColumn - 1, this._selection.endLineNumber, this._selection.endColumn - 1);
        }
        else {
            return new selection/* Selection */.Y(this._selection.startLineNumber, this._selection.startColumn + 1, this._selection.endLineNumber, this._selection.endColumn + 1);
        }
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.41.0/node_modules/monaco-editor/esm/vs/nls.js
var nls = __webpack_require__(80757);
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.41.0/node_modules/monaco-editor/esm/vs/editor/contrib/caretOperations/browser/caretOperations.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
class MoveCaretAction extends editorExtensions/* EditorAction */.R6 {
...
class MoveCaretLeftAction extends MoveCaretAction {
    constructor() {
        super(true, {
            ...
            label: nls/* localize */.NC('caret.moveLeft', "Move Selected Text Left"),
...
class MoveCaretRightAction extends MoveCaretAction {
    constructor() {
        super(false, {
            ...
            label: nls/* localize */.NC('caret.moveRight', "Move Selected Text Right"),
            alias: 'Move Selected Text Right',
            precondition: editorContextKeys/* EditorContextKeys */.u.writable
        });
    }
}
(0,editorExtensions/* registerEditorAction */.Qr)(MoveCaretLeftAction);
(0,editorExtensions/* registerEditorAction */.Qr)(MoveCaretRightAction);
...
/* harmony import */ var _common_commands_replaceCommand_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(46871);
/* harmony import */ var _common_cursor_cursorMoveOperations_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(28404);
/* harmony import */ var _common_core_range_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3981);
...
class TransposeLettersAction extends _browser_editorExtensions_js__WEBPACK_IMPORTED_MODULE_0__/* .EditorAction */ .R6 {
    constructor() {
        super({
            id: 'editor.action.transposeLetters',
            label: _nls_js__WEBPACK_IMPORTED_MODULE_3__/* .localize */ .NC('transposeLetters.label', "Transpose Letters"),
    ...
    run(accessor, editor) {
        ...
        for (const selection of selections) {
            ...
            const endPosition = (column === lastColumn) ?
                ...
                _common_cursor_cursorMoveOperations_js__WEBPACK_IMPORTED_MODULE_1__/* .MoveOperations */ .o.rightPosition(model, selection.getPosition().lineNumber, selection.getPosition().column);
            const middlePosition = _common_cursor_cursorMoveOperations_js__WEBPACK_IMPORTED_MODULE_1__/* .MoveOperations */ .o.leftPosition(model, endPosition);
            const beginPosition = _common_cursor_cursorMoveOperations_js__WEBPACK_IMPORTED_MODULE_1__/* .MoveOperations */ .o.leftPosition(model, middlePosition);
            const leftChar = model.getValueInRange(_common_core_range_js__WEBPACK_IMPORTED_MODULE_4__/* .Range */ .e.fromPositions(beginPosition, middlePosition));
            const rightChar = model.getValueInRange(_common_core_range_js__WEBPACK_IMPORTED_MODULE_4__/* .Range */ .e.fromPositions(middlePosition, endPosition));
            const replaceRange = _common_core_range_js__WEBPACK_IMPORTED_MODULE_4__/* .Range */ .e.fromPositions(beginPosition, endPosition);
            commands.push(new _common_commands_replaceCommand_js__WEBPACK_IMPORTED_MODULE_5__/* .ReplaceCommand */ .T4(replaceRange, rightChar + leftChar));
        }
...
(0,_browser_editorExtensions_js__WEBPACK_IMPORTED_MODULE_0__/* .registerEditorAction */ .Qr)(TransposeLettersAction);
