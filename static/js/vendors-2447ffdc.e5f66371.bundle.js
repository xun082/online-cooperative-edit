"use strict";
(self["webpackChunkedit"] = self["webpackChunkedit"] || []).push([["vendors-2447ffdc"],{
...
/* harmony import */ var _base_common_lifecycle_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(26794);
/* harmony import */ var _base_common_objects_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(19525);
/* harmony import */ var _common_core_range_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3981);
/* harmony import */ var _platform_audioCues_browser_audioCueService_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(35758);
/* harmony import */ var _services_codeEditorService_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(41886);
/* harmony import */ var _platform_accessibility_common_accessibility_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(25919);
/*---------------------------------------------------------------------------------------------
...
/* harmony import */ var _base_browser_fastDomNode_js__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(27661);
/* harmony import */ var _base_browser_trustedTypes_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(68069);
/* harmony import */ var _base_browser_ui_actionbar_actionbar_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(31768);
/* harmony import */ var _base_browser_ui_scrollbar_scrollableElement_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(85489);
/* harmony import */ var _base_common_actions_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(25541);
/* harmony import */ var _base_common_codicons_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(13113);
/* harmony import */ var _base_common_lifecycle_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(26794);
/* harmony import */ var _base_common_themables_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(50077);
/* harmony import */ var _media_diffReview_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(80909);
/* harmony import */ var _config_domFontInfo_js__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(93887);
/* harmony import */ var _common_config_editorOptions_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(58908);
/* harmony import */ var _common_core_position_js__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(65201);
/* harmony import */ var _common_languages_language_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(57164);
/* harmony import */ var _common_tokens_lineTokens_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(15792);
/* harmony import */ var _common_viewLayout_viewLineRenderer_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(60533);
/* harmony import */ var _common_viewModel_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(1975);
/* harmony import */ var _nls_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(80757);
/* harmony import */ var _platform_audioCues_browser_audioCueService_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(35758);
/* harmony import */ var _platform_configuration_common_configuration_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(99779);
/* harmony import */ var _platform_theme_common_iconRegistry_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(85519);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
const diffReviewInsertIcon = (0,_platform_theme_common_iconRegistry_js__WEBPACK_IMPORTED_MODULE_17__/* .registerIcon */ .q5)('diff-review-insert', _base_common_codicons_js__WEBPACK_IMPORTED_MODULE_5__/* .Codicon */ .l.add, _nls_js__WEBPACK_IMPORTED_MODULE_14__/* .localize */ .NC('diffReviewInsertIcon', 'Icon for \'Insert\' in diff review.'));
const diffReviewRemoveIcon = (0,_platform_theme_common_iconRegistry_js__WEBPACK_IMPORTED_MODULE_17__/* .registerIcon */ .q5)('diff-review-remove', _base_common_codicons_js__WEBPACK_IMPORTED_MODULE_5__/* .Codicon */ .l.remove, _nls_js__WEBPACK_IMPORTED_MODULE_14__/* .localize */ .NC('diffReviewRemoveIcon', 'Icon for \'Remove\' in diff review.'));
const diffReviewCloseIcon = (0,_platform_theme_common_iconRegistry_js__WEBPACK_IMPORTED_MODULE_17__/* .registerIcon */ .q5)('diff-review-close', _base_common_codicons_js__WEBPACK_IMPORTED_MODULE_5__/* .Codicon */ .l.close, _nls_js__WEBPACK_IMPORTED_MODULE_14__/* .localize */ .NC('diffReviewCloseIcon', 'Icon for \'Close\' in diff review.'));
let DiffReview = class DiffReview extends _base_common_lifecycle_js__WEBPACK_IMPORTED_MODULE_6__/* .Disposable */ .JT {
    constructor(diffEditor, _languageService, _audioCueService, _configurationService) {
        ...
        this.shadow = (0,_base_browser_fastDomNode_js__WEBPACK_IMPORTED_MODULE_18__/* .createFastDomNode */ .X)(document.createElement('div'));
        this.shadow.setClassName('diff-review-shadow');
        this.actionBarContainer = (0,_base_browser_fastDomNode_js__WEBPACK_IMPORTED_MODULE_18__/* .createFastDomNode */ .X)(document.createElement('div'));
        ...
        this._actionBar.push(new _base_common_actions_js__WEBPACK_IMPORTED_MODULE_4__/* .Action */ .aU('diffreview.close', _nls_js__WEBPACK_IMPORTED_MODULE_14__/* .localize */ .NC('label.close', "Close"), 'close-diff-review ' + _base_common_themables_js__WEBPACK_IMPORTED_MODULE_7__/* .ThemeIcon */ .k.asClassName(diffReviewCloseIcon), true, () => __awaiter(this, void 0, void 0, function* () { return this.hide(); })), { label: false, icon: true });
        this.domNode = (0,_base_browser_fastDomNode_js__WEBPACK_IMPORTED_MODULE_18__/* .createFastDomNode */ .X)(document.createElement('div'));
        this.domNode.setClassName('diff-review monaco-editor-background');
        this._content = (0,_base_browser_fastDomNode_js__WEBPACK_IMPORTED_MODULE_18__/* .createFastDomNode */ .X)(document.createElement('div'));
    ...
    prev() {
        ...
        this._diffEditor.setPosition(new _common_core_position_js__WEBPACK_IMPORTED_MODULE_19__/* .Position */ .L(entries[0].modifiedLineStart, 1));
    ...
    accept() {
        ...
        if (jumpToLineNumber !== -1) {
            this._diffEditor.setPosition(new _common_core_position_js__WEBPACK_IMPORTED_MODULE_19__/* .Position */ .L(jumpToLineNumber, 1));
            this._diffEditor.revealPosition(new _common_core_position_js__WEBPACK_IMPORTED_MODULE_19__/* .Position */ .L(jumpToLineNumber, 1), 1 /* ScrollType.Immediate */);
        }
    }
    hide() {
        this._isVisible = false;
    ...
    _goToRow(row, type) {
        ...
        if (element === null || element === void 0 ? void 0 : element.classList.contains("line-insert" /* DiffEditorLineClasses.Insert */)) {
            this._audioCueService.playAudioCue(_platform_audioCues_browser_audioCueService_js__WEBPACK_IMPORTED_MODULE_15__/* .AudioCue */ .y$.diffLineInserted, true);
        }
        else if (element === null || element === void 0 ? void 0 : element.classList.contains("line-delete" /* DiffEditorLineClasses.Delete */)) {
            this._audioCueService.playAudioCue(_platform_audioCues_browser_audioCueService_js__WEBPACK_IMPORTED_MODULE_15__/* .AudioCue */ .y$.diffLineDeleted, true);
        }
    ...
    _render() {
        ...
        (0,_config_domFontInfo_js__WEBPACK_IMPORTED_MODULE_20__/* .applyFontInfo */ .N)(container, modifiedOptions.get(49 /* EditorOption.fontInfo */));
        ...
        const getAriaLines = (lines) => {
            if (lines === 0) {
                return _nls_js__WEBPACK_IMPORTED_MODULE_14__/* .localize */ .NC('no_lines_changed', "no lines changed");
            }
            else if (lines === 1) {
                return _nls_js__WEBPACK_IMPORTED_MODULE_14__/* .localize */ .NC('one_line_changed', "1 line changed");
            }
            else {
                return _nls_js__WEBPACK_IMPORTED_MODULE_14__/* .localize */ .NC('more_lines_changed', "{0} lines changed", lines);
            }
        };
        ...
        header.setAttribute('aria-label', _nls_js__WEBPACK_IMPORTED_MODULE_14__/* .localize */ .NC({
            key: 'header',
            comment: [
    ...
    static _renderSection(dest, diffEntry, modLine, lineHeight, width, originalOptions, originalModel, originalModelOpts, modifiedOptions, modifiedModel, modifiedModelOpts, languageIdCodec) {
        ...
        for (let i = 0; i <= cnt; i++) {
            ...
            if (lineContent.length === 0) {
                lineContent = _nls_js__WEBPACK_IMPORTED_MODULE_14__/* .localize */ .NC('blankLine', "blank");
            }
            let ariaLabel = '';
            switch (type) {
                case 0 /* DiffEntryType.Equal */:
                    if (originalLine === modifiedLine) {
                        ariaLabel = _nls_js__WEBPACK_IMPORTED_MODULE_14__/* .localize */ .NC({ key: 'unchangedLine', comment: ['The placeholders are contents of the line and should not be translated.'] }, "{0} unchanged line {1}", lineContent, originalLine);
                    }
                    else {
                        ariaLabel = _nls_js__WEBPACK_IMPORTED_MODULE_14__/* .localize */ .NC('equalLine', "{0} original line {1} modified line {2}", lineContent, originalLine, modifiedLine);
                    }
                    break;
                case 1 /* DiffEntryType.Insert */:
                    ariaLabel = _nls_js__WEBPACK_IMPORTED_MODULE_14__/* .localize */ .NC('insertLine', "+ {0} modified line {1}", lineContent, modifiedLine);
                    break;
                case 2 /* DiffEntryType.Delete */:
                    ariaLabel = _nls_js__WEBPACK_IMPORTED_MODULE_14__/* .localize */ .NC('deleteLine', "- {0} original line {1}", lineContent, originalLine);
                    break;
            }
    ...
    static _renderLine(model, options, tabSize, lineNumber, languageIdCodec) {
        ...
        const lineTokens = _common_tokens_lineTokens_js__WEBPACK_IMPORTED_MODULE_11__/* .LineTokens */ .A.createEmpty(lineContent, languageIdCodec);
        const isBasicASCII = _common_viewModel_js__WEBPACK_IMPORTED_MODULE_13__/* .ViewLineRenderingData */ .wA.isBasicASCII(lineContent, model.mightContainNonBasicASCII());
        const containsRTL = _common_viewModel_js__WEBPACK_IMPORTED_MODULE_13__/* .ViewLineRenderingData */ .wA.containsRTL(lineContent, isBasicASCII, model.mightContainRTL());
        const r = (0,_common_viewLayout_viewLineRenderer_js__WEBPACK_IMPORTED_MODULE_12__/* .renderViewLine2 */ .tF)(new _common_viewLayout_viewLineRenderer_js__WEBPACK_IMPORTED_MODULE_12__/* .RenderLineInput */ .IJ((fontInfo.isMonospace && !options.get(32 /* EditorOption.disableMonospaceOptimizations */)), fontInfo.canUseHalfwidthRightwardsArrow, lineContent, false, isBasicASCII, containsRTL, 0, lineTokens, [], tabSize, 0, fontInfo.spaceWidth, fontInfo.middotWidth, fontInfo.wsmiddotWidth, options.get(115 /* EditorOption.stopRenderingLineAfter */), options.get(97 /* EditorOption.renderWhitespace */), options.get(92 /* EditorOption.renderControlCharacters */), options.get(50 /* EditorOption.fontLigatures */) !== _common_config_editorOptions_js__WEBPACK_IMPORTED_MODULE_9__/* .EditorFontLigatures */ .n0.OFF, null));
        return r.html;
    }
};
...
DiffReview = __decorate([
    __param(1, _common_languages_language_js__WEBPACK_IMPORTED_MODULE_10__/* .ILanguageService */ .O),
    __param(2, _platform_audioCues_browser_audioCueService_js__WEBPACK_IMPORTED_MODULE_15__/* .IAudioCueService */ .e7),
    __param(3, _platform_configuration_common_configuration_js__WEBPACK_IMPORTED_MODULE_16__/* .IConfigurationService */ .Ui)
], DiffReview);
