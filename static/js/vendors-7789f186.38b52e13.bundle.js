"use strict";
(self["webpackChunkedit"] = self["webpackChunkedit"] || []).push([["vendors-7789f186"],{
...
/* harmony import */ var _core_rgba_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(54319);
/* harmony import */ var _languages_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(58606);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony export */ });
/* harmony import */ var _base_common_strings_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(23607);
/* harmony import */ var _core_characterClassifier_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(43332);
/* harmony import */ var _textModelEvents_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(67033);
/* harmony import */ var _modelLineProjectionData_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(97579);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony export */ });
/* harmony import */ var _editorTheme_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2619);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var _viewModel_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(76414);
/* harmony import */ var _config_editorOptions_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(75117);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
    ...
    _getOrCreateViewModelDecoration(modelDecoration) {
        ...
        if (!r) {
            ...
            if (options.isWholeLine) {
                const start = this._coordinatesConverter.convertModelPositionToViewPosition(new _core_position_js__WEBPACK_IMPORTED_MODULE_2__/* .Position */ .L(modelRange.startLineNumber, 1), 0 /* PositionAffinity.Left */);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/cursor/cursor.js
var cursor = __webpack_require__(83065);
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/cursorCommon.js
var cursorCommon = __webpack_require__(68273);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/viewEvents.js
var viewEvents = __webpack_require__(86493);
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/viewLayout/viewLayout.js + 1 modules
var viewLayout = __webpack_require__(55847);
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/viewModel/minimapTokensColorTracker.js
var minimapTokensColorTracker = __webpack_require__(75798);
...
var lineTokens = __webpack_require__(15834);
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/viewModel/modelLineProjection.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
// EXTERNAL MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/model/prefixSumComputer.js
var prefixSumComputer = __webpack_require__(43574);
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/viewModel/viewModelLines.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/monaco-editor@0.39.0/node_modules/monaco-editor/esm/vs/editor/common/viewModel/viewModelImpl.js
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
    ...
    _registerModelEvents() {
        ...
        this._register(this.model.onDidChangeDecorations((e) => {
            ...
            if (e.affectsGlyphMargin) {
                ...
                decorations.sort((a, b) => core_range/* Range */.e.compareRangesUsingStarts(a.range, b.range));
                let leftDecRange = null;
                let rightDecRange = null;
                for (const decoration of decorations) {
                    const position = (_b = (_a = decoration.options.glyphMargin) === null || _a === void 0 ? void 0 : _a.position) !== null && _b !== void 0 ? _b : model/* GlyphMarginLane */.U.Left;
                    if (position === model/* GlyphMarginLane */.U.Left && (!leftDecRange || core_range/* Range */.e.compareRangesUsingEnds(leftDecRange, decoration.range) < 0)) {
                    ...
                    if (position === model/* GlyphMarginLane */.U.Right && (!rightDecRange || core_range/* Range */.e.compareRangesUsingEnds(rightDecRange, decoration.range) < 0)) {
                        // assign only if the range of `decoration` ends after, which means it has a higher chance to overlap with the other lane
