"use strict";
(self["webpackChunkedit"] = self["webpackChunkedit"] || []).push([["vendors-06fdea35"],{
...
/* harmony export */ });
/* harmony import */ var _coreCommands_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(50102);
...
class ViewController {
    ...
    setSelection(modelSelection) {
        _coreCommands_js__WEBPACK_IMPORTED_MODULE_0__/* .CoreNavigationCommands */ .Ox.SetSelection.runCoreEditorCommand(this.viewModel, {
            source: 'keyboard',
    ...
    dispatchMouse(data) {
        ...
        const selectionClipboardIsOn = (_base_common_platform_js__WEBPACK_IMPORTED_MODULE_1__/* .isLinux */ .IJ && options.get(105 /* EditorOption.selectionClipboard */));
    ...
    moveTo(viewPosition, revealType) {
        _coreCommands_js__WEBPACK_IMPORTED_MODULE_0__/* .CoreNavigationCommands */ .Ox.MoveTo.runCoreEditorCommand(this.viewModel, this._usualArgs(viewPosition, revealType));
    }
    _moveToSelect(viewPosition, revealType) {
        _coreCommands_js__WEBPACK_IMPORTED_MODULE_0__/* .CoreNavigationCommands */ .Ox.MoveToSelect.runCoreEditorCommand(this.viewModel, this._usualArgs(viewPosition, revealType));
    }
    _columnSelect(viewPosition, mouseColumn, doColumnSelect) {
        viewPosition = this._validateViewColumn(viewPosition);
        _coreCommands_js__WEBPACK_IMPORTED_MODULE_0__/* .CoreNavigationCommands */ .Ox.ColumnSelect.runCoreEditorCommand(this.viewModel, {
            source: 'mouse',
            position: this._convertViewToModelPosition(viewPosition),
    ...
    _createCursor(viewPosition, wholeLine) {
        viewPosition = this._validateViewColumn(viewPosition);
        _coreCommands_js__WEBPACK_IMPORTED_MODULE_0__/* .CoreNavigationCommands */ .Ox.CreateCursor.runCoreEditorCommand(this.viewModel, {
            source: 'mouse',
            position: this._convertViewToModelPosition(viewPosition),
            viewPosition: viewPosition,
            wholeLine: wholeLine
    ...
    _lastCursorMoveToSelect(viewPosition, revealType) {
        _coreCommands_js__WEBPACK_IMPORTED_MODULE_0__/* .CoreNavigationCommands */ .Ox.LastCursorMoveToSelect.runCoreEditorCommand(this.viewModel, this._usualArgs(viewPosition, revealType));
    }
    _wordSelect(viewPosition, revealType) {
        _coreCommands_js__WEBPACK_IMPORTED_MODULE_0__/* .CoreNavigationCommands */ .Ox.WordSelect.runCoreEditorCommand(this.viewModel, this._usualArgs(viewPosition, revealType));
    }
    _wordSelectDrag(viewPosition, revealType) {
        _coreCommands_js__WEBPACK_IMPORTED_MODULE_0__/* .CoreNavigationCommands */ .Ox.WordSelectDrag.runCoreEditorCommand(this.viewModel, this._usualArgs(viewPosition, revealType));
    }
    _lastCursorWordSelect(viewPosition, revealType) {
        _coreCommands_js__WEBPACK_IMPORTED_MODULE_0__/* .CoreNavigationCommands */ .Ox.LastCursorWordSelect.runCoreEditorCommand(this.viewModel, this._usualArgs(viewPosition, revealType));
    }
    _lineSelect(viewPosition, revealType) {
        _coreCommands_js__WEBPACK_IMPORTED_MODULE_0__/* .CoreNavigationCommands */ .Ox.LineSelect.runCoreEditorCommand(this.viewModel, this._usualArgs(viewPosition, revealType));
    }
    _lineSelectDrag(viewPosition, revealType) {
        _coreCommands_js__WEBPACK_IMPORTED_MODULE_0__/* .CoreNavigationCommands */ .Ox.LineSelectDrag.runCoreEditorCommand(this.viewModel, this._usualArgs(viewPosition, revealType));
    }
    _lastCursorLineSelect(viewPosition, revealType) {
        _coreCommands_js__WEBPACK_IMPORTED_MODULE_0__/* .CoreNavigationCommands */ .Ox.LastCursorLineSelect.runCoreEditorCommand(this.viewModel, this._usualArgs(viewPosition, revealType));
    }
    _lastCursorLineSelectDrag(viewPosition, revealType) {
        _coreCommands_js__WEBPACK_IMPORTED_MODULE_0__/* .CoreNavigationCommands */ .Ox.LastCursorLineSelectDrag.runCoreEditorCommand(this.viewModel, this._usualArgs(viewPosition, revealType));
    }
    _selectAll() {
        _coreCommands_js__WEBPACK_IMPORTED_MODULE_0__/* .CoreNavigationCommands */ .Ox.SelectAll.runCoreEditorCommand(this.viewModel, { source: 'mouse' });
    }
    // ----------------------
...
/* harmony export */ });
/* harmony import */ var _base_browser_fastDomNode_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(27661);
/* harmony import */ var _base_browser_trustedTypes_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(68069);
...
/* harmony import */ var _base_browser_fastDomNode_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(27661);
/* harmony import */ var _config_domFontInfo_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(93887);
/* harmony import */ var _viewLayer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(88471);
/* harmony import */ var _viewPart_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(53379);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
class MarginViewOverlays extends ViewOverlays {
    constructor(context) {
        ...
        (0,_config_domFontInfo_js__WEBPACK_IMPORTED_MODULE_2__/* .applyFontInfo */ .N)(this.domNode, options.get(49 /* EditorOption.fontInfo */));
    }
    onConfigurationChanged(e) {
        const options = this._context.configuration.options;
        (0,_config_domFontInfo_js__WEBPACK_IMPORTED_MODULE_2__/* .applyFontInfo */ .N)(this.domNode, options.get(49 /* EditorOption.fontInfo */));
...
/* harmony export */ });
/* harmony import */ var _common_core_position_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(65201);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
